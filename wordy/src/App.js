...
function App() {
  return (
    <main className="relative w-full h-screen flex justify-center items-center">
       <header className="z-20 absolute top-[3em] self-center">
            <div className="flex">
                <Link to="/"><img src={Logo} className="h-12 self-center mx-4" alt="" /></Link>
                <h1 className="font-sans font-extrabold text-7xl text-coral" id="homeTitle">Wordy Dictionary</h1>
            </div>
        </header>
